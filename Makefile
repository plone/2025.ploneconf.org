...
PROJECT_NAME=2025.ploneconf.org
...
stack-start:  ## Local Stack: Start Services
	...
	@echo "Now visit: http://2025.ploneconf.org.localhost"
...
acceptance-frontend-image-build:
	...
	@docker build frontend -t plone/2025.ploneconf.org-frontend:acceptance -f frontend/Dockerfile --build-arg VOLTO_VERSION=$(VOLTO_VERSION)

.PHONY: acceptance-backend-image-build
acceptance-backend-image-build:
	@echo "Build acceptance backend image"
	@docker build backend -t plone/2025.ploneconf.org-backend:acceptance -f backend/Dockerfile.acceptance --build-arg PLONE_VERSION=$(PLONE_VERSION)
...
acceptance-frontend-container-start:
	@echo "Start acceptance frontend"
	@docker run --rm -p 3000:3000 --name 2025.ploneconf.org-frontend-acceptance --link 2025.ploneconf.org-backend-acceptance:backend -e RAZZLE_API_PATH=http://localhost:55001/plone -e RAZZLE_INTERNAL_API_PATH=http://backend:55001/plone -d plone/2025.ploneconf.org-frontend:acceptance

.PHONY: acceptance-backend-container-start
acceptance-backend-container-start:
	@echo "Start acceptance backend"
	@docker run --rm -p 55001:55001 --name 2025.ploneconf.org-backend-acceptance -d plone/2025.ploneconf.org-backend:acceptance
...
acceptance-containers-stop: ## Stop Acceptance containers
	...
	@docker stop 2025.ploneconf.org-frontend-acceptance
	@docker stop 2025.ploneconf.org-backend-acceptance
